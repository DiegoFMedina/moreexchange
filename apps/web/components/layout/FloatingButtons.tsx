...
// DESC: FABs — WhatsApp y selector de idioma, adaptado a tema claro
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-end" ref={langWrapRef}>
        <div
          className={[
            'absolute bottom-[62px] right-0 min-w-[195px] rounded-[14px] border border-[#E2E5F1] bg-white px-2 py-2 shadow-xl',
            ...
            <button
              ...
              className={[
                ...
                activeLang.code === lang.code
                  ? 'border-[#2458F5]/30 bg-[#2458F5]/10 font-medium text-[#2458F5]'
                  : 'text-[#5C6489] hover:translate-x-[-2px] hover:border-[#2458F5]/20 hover:bg-[#F5F7FE] hover:text-[#1B2141]',
              ].join(' ')}
              role="menuitem"
            >
              <span className="text-[19px] leading-none">{lang.flag}</span>
              <span className="flex-1">{lang.name}</span>
              <span className="text-[10px] font-mono tracking-wide text-[#2458F5]/60">
                {lang.lcode}
              </span>
            </button>
          ))}
          <div className="my-1 h-px bg-[#E2E5F1] mx-1" aria-hidden />
        ...
        <button
          ...
          className={[
            ...
            'bg-white border-[#E2E5F1] shadow-[0_4px_22px_rgba(36,58,133,0.12)]',
            'hover:scale-[1.08] hover:border-[#2458F5] hover:shadow-[0_6px_30px_rgba(36,88,245,0.2)]',
            langOpen && 'border-[#2458F5] bg-[#F5F7FE]',
          ].join(' ')}
        ...
        >
          <span className="relative">
            {activeLang.flag}
            <span className="absolute right-[60px] top-1/2 -translate-y-1/2 whitespace-nowrap rounded-md border border-[#E2E5F1] bg-white px-3 py-1.5 text-[12px] font-medium text-[#1B2141] opacity-0 transition-opacity duration-[180ms] pointer-events-none group-hover:opacity-100 shadow-lg">
              Cambiar idioma
            </span>
          </span>
        </button>
